 ...
 * @property \App\Model\Table\ResearchersTable&\Cake\ORM\Association\BelongsTo $Researchers
 *
...
class RecordsTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn('research_id', 'Researchers'), ['errorField' => 'research_id']);
