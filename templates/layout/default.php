...
<head>
    ...
    <title>CURE MECP2</title>
    <?= $this->Html->meta('icon') ?>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Halant:wght@400;600&family=Reem+Kufi&family=Sen&display=swap"
        rel="stylesheet">
    <?= $this->Html->css(['sb-admin', 'bootstrap','normalize.min', 'cake', 'index']) ?>
    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="/contents/view/1"
                        class="nav-link <?php if($this->request->getParam('pass')[0]==='1'){echo 'active';}?>">
                        Contact</a>
                </li>

                <li class="nav-item"><a href="/users/signin"
                        class="nav-link <?php if($this->request->getParam('pass')[0]==='signin'){echo 'active';}?>">Login</a>
                </li>
            </ul>
        </header>
        <h2 class="companyName">CURE & MECP2</h2>
    </div>
    <main class="main">
        <div class="container">
            <?= $this->Flash->render() ?>
