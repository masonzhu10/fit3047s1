...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Tables -->
        <li
            class="nav-item  <?php if($this->request->getAttribute('params')['controller']==='Researchers' && $this->request->getAttribute('params')['action']==='index'){echo 'active';} ?> ">
            <a class=" nav-link" href="/researcher">
                <i class="fas fa-fw fa-table"></i>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Amy</span>
